...
public class ClienteControlador {
    ...
    public ResponseEntity<ClienteDto> actualizar(@PathVariable Long id, @Valid @RequestBody ClienteDto solicitud) {
        var entrada = new ClienteDto(id, solicitud.nombre(), solicitud.contrasena(), solicitud.email(), solicitud.licencia(), solicitud.calle(), solicitud.ciudad(), solicitud.fechaLicencia());
