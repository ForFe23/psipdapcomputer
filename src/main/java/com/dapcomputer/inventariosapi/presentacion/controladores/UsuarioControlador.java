...
public class UsuarioControlador {
    ...
    public ResponseEntity<UsuarioDto> actualizar(@PathVariable Integer id, @Valid @RequestBody UsuarioDto solicitud) {
        var entrada = new UsuarioDto(id, solicitud.idCliente(), solicitud.cedula(), solicitud.apellidos(), solicitud.nombres(), solicitud.cargo(), solicitud.solfrnrf(), solicitud.correo(), solicitud.telefono(), solicitud.estatus(), solicitud.fechaRegistro());
