...
public class PersonaControlador {
    ...
    public ResponseEntity<PersonaDto> actualizar(@PathVariable Integer id, @Valid @RequestBody PersonaDto solicitud) {
        var entrada = new PersonaDto(id, solicitud.empresaId(), solicitud.cedula(), solicitud.apellidos(), solicitud.nombres(), solicitud.correo(), solicitud.telefono(), solicitud.cargo(), solicitud.estadoInterno());
