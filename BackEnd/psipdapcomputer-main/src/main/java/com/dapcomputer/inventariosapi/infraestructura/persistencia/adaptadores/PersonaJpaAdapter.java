...
public class PersonaJpaAdapter implements IPersonaRepositorio {
    ...
    public Persona guardar(Persona persona) {
        ...
        if (entidad.getClienteId() == null && entidad.getEmpresaId() == null) {
            throw new IllegalArgumentException("La persona debe pertenecer a un cliente o a una empresa.");
        }
        ...
        entidad.setCargo(normalizar(entidad.getCargo()));
    ...
    @Override
    public List<Persona> listarPorCliente(Long clienteId) {
