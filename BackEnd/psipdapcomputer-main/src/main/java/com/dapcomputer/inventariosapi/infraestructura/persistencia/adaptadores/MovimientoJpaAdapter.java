...
public class MovimientoJpaAdapter implements MovimientoRepositorio {
    ...
    public Movimiento guardar(Movimiento movimiento) {
        ...
        if (guardado.getIdEquipo() != null) {
            Long destinoEmpresa = guardado.getEmpresaId();
            if (destinoEmpresa == null && acta != null) {
                destinoEmpresa = acta.getEmpresaId();
            }
            if (guardado.getUbicacionDestinoId() != null) {
                equipoRepository.actualizarUbicacionYEmpresa(
                        guardado.getIdEquipo(),
                        guardado.getUbicacionDestinoId(),
                        guardado.getUbicacionDestino(),
                        destinoEmpresa);
            } else if (destinoEmpresa != null) {
                equipoRepository.actualizarUbicacionYEmpresa(
                        guardado.getIdEquipo(),
                        null,
                        guardado.getUbicacionDestino(),
